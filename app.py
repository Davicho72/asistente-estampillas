...
""", title="Asistente Estampillas") as demo:
    ...
    with gr.Column(visible=False) as pantalla_principal:
        ...
        modo = gr.Radio(["📂 Galería", "📸 Tomar foto"], label="Elige cómo subir:")
    ...
    btn_entrar.click(verificar, entrada_clave, [pantalla_acceso, pantalla_principal, mensaje_acceso])
